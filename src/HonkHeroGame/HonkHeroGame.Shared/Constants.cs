...
namespace HonkHeroGame
{
    public static class Constants
    {
        ...
        {
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle1_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle2_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle3_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle4_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle5_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle6_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle7_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle8_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle9_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle10_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle11_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle12_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle13_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle14_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle15_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle16_up.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_UPSTREAM, new Uri("ms-appx:///Assets/Images/vehicle17_up.png")),

            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle1_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle2_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle3_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle4_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle5_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle6_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle7_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle8_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle9_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle10_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle11_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle12_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle13_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle14_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle15_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle16_down.png")),
            new KeyValuePair<ElementType, Uri>(ElementType.VEHICLE_DOWNSTREAM, new Uri("ms-appx:///Assets/Images/vehicle17_down.png")),
