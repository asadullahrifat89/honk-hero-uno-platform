...
namespace HonkHeroGame
{
    public sealed partial class GamePlayPage : Page
    {
        ...
        private void UpdateVehicle(Vehicle vehicle)
        {
            ...
            if (GameView.Children.OfType<Vehicle>().Any(x => x.GetCollisionPreventionHitBox(_scale).IntersectsWith(vehicle.GetCollisionPreventionHitBox(_scale)) && vehicle.Speed > x.Speed))
            {
